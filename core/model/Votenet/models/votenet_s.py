...
from backbone_module_s import Pointnet2Backbone
from voting_module import VotingModule
from proposal_module_s import ProposalModule
from dump_helper import dump_results
from loss_helper import get_loss


class VoteNet_S(nn.Module):
    r"""
    ...
    def __init__(self, num_class, num_heading_bin, num_size_cluster, mean_size_arr,
        input_feature_dim=0, num_proposal=128, vote_factor=1, sampling='vote_fps', scale_factor=2, mask_probability=0.):
        super().__init__()
    ...
    def forward(self, inputs, output_t=None, masked_ind_list=None):
        ...
        end_points = self.backbone_net(inputs['point_clouds'], end_points, output_t, masked_ind_list)
